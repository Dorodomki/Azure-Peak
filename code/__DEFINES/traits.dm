...
#define TRAIT_SHAMAN "Shamanic hood" //atgervi merc no hood debuff
...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_SHAMAN = span_notice("My hood, I need it. The ire of the Moose is upon me. I feel his smile.."),
))
